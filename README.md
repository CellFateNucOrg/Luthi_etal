...
Results of the differential gene expression analysis (DESeq2) used for plotting are in ./RNAseq_DGE

Results of the differential transcript expression analysis (Sleuth) used for plotting are in ./RNAseq_DTE
