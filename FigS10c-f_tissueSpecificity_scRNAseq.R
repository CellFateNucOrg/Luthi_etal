...
p<-cowplot::plot_grid(plotlist=list(plot_grid(p1,p2,ncol=2,labels=c("c ","d ")),
                      p3),
                      nrow=3, labels=c("","e "), rel_heights=c(1,1))

ggsave(filename=paste0(finalFigDir,"/FigS10c-f_tissueSpecificity_scRNAseq.png"),p,height=29,width=20,units="cm",device="png")
