...
rnaSeqFile<-"/Users/semple/Documents/MeisterLab/otherPeopleProjects/Moushumi/2021_RNAseq_MDas/rds/p0.05_lfc0.5_filtCycChrAX/filtCycChrAX_X.wt.wt.0mM_dpy26cs_vs_wt_DESeq2_fullResults_p0.05.rds"

fileList<-data.frame(sampleName=c("DPY-26cs"),
...
p
ggsave(paste0(finalFigDir,"/RNAseq_fountains_counts&jitter_DPY-26.pdf"), p, device="pdf",
